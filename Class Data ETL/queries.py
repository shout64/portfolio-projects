...
SELECT 
    ...
    CASE
		WHEN COUNT(X_LISTED_PARNT_CRS) OVER (PARTITION BY X_LISTED_PARNT_CRS) > 1 THEN RTRIM(X_LISTED_PARNT_CRS)
		ELSE NULL
	END [Cross-List Code],
	CASE
		WHEN X_LISTED_SECTION = 'C' THEN NULL
		WHEN COUNT(X_LISTED_PARNT_CRS) OVER (PARTITION BY X_LISTED_PARNT_CRS) > 1 THEN 'P'
		ELSE NULL
